...
**Object Store File Manager** — SAPUI5 TypeScript frontend + CAP Node.js REST backend for managing files on SAP BTP Object Store (S3-compatible). Targets SAP Build Work Zone.
...
- **Frontend** (`app/webapp/`): SAPUI5 1.148.1, namespace `com.sap.objectstorefilemanager`, TypeScript with `ui5-tooling-transpile`.
